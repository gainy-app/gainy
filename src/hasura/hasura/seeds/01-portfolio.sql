...
from app.profiles
         ...
         left join app.profile_plaid_access_tokens on profile_plaid_access_tokens.profile_id = profiles.id
where profiles.id = 1 and profile_plaid_access_tokens is null
on conflict do nothing;
...
from app.profiles
         left join app.profile_plaid_access_tokens on profile_plaid_access_tokens.profile_id = profiles.id
where profiles.id = 3 and profile_plaid_access_tokens is null
on conflict do nothing;
