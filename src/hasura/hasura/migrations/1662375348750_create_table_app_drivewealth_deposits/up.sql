CREATE TABLE "app"."drivewealth_deposits"
(
...
END;
$$ LANGUAGE plpgsql;
CREATE TRIGGER "set_app_drivewealth_deposits_updated_at"
    BEFORE UPDATE
    ON "app"."drivewealth_deposits"
    FOR EACH ROW
EXECUTE PROCEDURE "app"."set_current_timestamp_updated_at"();
COMMENT ON TRIGGER "set_app_drivewealth_deposits_updated_at" ON "app"."drivewealth_deposits"
