...
class GetRecommendedCollections(HasuraAction):
    ...
    def apply(self, db_conn, input_params, headers):
        ...
        is_top_20_enabled = repository.is_collection_enabled(profile_id, TOP_20_FOR_YOU_COLLECTION_ID)
        if is_top_20_enabled:
            sorted_collections_ids = [TOP_20_FOR_YOU_COLLECTION_ID] + sorted_collections_ids
