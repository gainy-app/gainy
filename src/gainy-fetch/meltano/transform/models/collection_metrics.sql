             ...
             from all_ticker_collections
                      ...
                      join {{ ref('profile_collections') }}
                           on profile_collections.id = all_ticker_collections.collection_id
                                and (profile_collections.profile_id = all_ticker_collections.profile_id
                                    or (profile_collections.profile_id is null and all_ticker_collections.profile_id is null))
         ),
