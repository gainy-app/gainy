...
alter table deployment.public_schemas add column if not exists sqs_handler_lambda_arn text;
alter table deployment.public_schemas add column if not exists set_active_at timestamp;
