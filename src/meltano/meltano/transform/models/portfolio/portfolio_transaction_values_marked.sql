...
select transaction_uniq_id,
       ...
       case
           when historical_prices_marked.date_0d >= portfolio_expanded_transactions.datetime
               then quantity * price_0d
           end                                        as value_0d,
       historical_prices_marked.date_1w,
       case
           when historical_prices_marked.date_1w >= portfolio_expanded_transactions.datetime
               then quantity * price_1w
           end                                        as value_1w,
       historical_prices_marked.date_10d,
       case
           when historical_prices_marked.date_10d >= portfolio_expanded_transactions.datetime
               then quantity * price_10d
           end                                        as value_10d,
       historical_prices_marked.date_1m,
       case
           when historical_prices_marked.date_1m >= portfolio_expanded_transactions.datetime
               then quantity * price_1m
           end                                        as value_1m,
       historical_prices_marked.date_2m,
       case
           when historical_prices_marked.date_2m >= portfolio_expanded_transactions.datetime
               then quantity * price_2m
           end                                        as value_2m,
       historical_prices_marked.date_3m,
       case
           when historical_prices_marked.date_3m >= portfolio_expanded_transactions.datetime
               then quantity * price_3m
           end                                        as value_3m,
       historical_prices_marked.date_1y,
       case
           when historical_prices_marked.date_1y >= portfolio_expanded_transactions.datetime
               then quantity * price_1y
           end                                        as value_1y,
       historical_prices_marked.date_13m,
       case
           when historical_prices_marked.date_13m >= portfolio_expanded_transactions.datetime
               then quantity * price_13m
           end                                        as value_13m,
       historical_prices_marked.date_5y,
       case
           when historical_prices_marked.date_5y >= portfolio_expanded_transactions.datetime
