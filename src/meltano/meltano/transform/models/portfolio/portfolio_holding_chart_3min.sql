...
from (
         select portfolio_holding_chart_1d.holding_id_v2,
                ...
                portfolio_holding_chart_1d.open * historical_prices_aggregated_3min.open /
                    historical_prices_aggregated_1d.open          as open,
                portfolio_holding_chart_1d.open * historical_prices_aggregated_3min.high /
                    historical_prices_aggregated_1d.open          as high,
                portfolio_holding_chart_1d.open * historical_prices_aggregated_3min.low /
                    historical_prices_aggregated_1d.open          as low,
                portfolio_holding_chart_1d.open * historical_prices_aggregated_3min.close /
                    historical_prices_aggregated_1d.open          as close,
                portfolio_holding_chart_1d.open * historical_prices_aggregated_3min.adjusted_close /
