...
{% endif %}
             ...
             from min_holding_date
                      ...
                      left join {{ ref('historical_prices_aggregated_3min') }} on historical_prices_aggregated_3min.symbol = 'SPY'
             where min_holding_date.symbol = 'CUR:USD'
               and (historical_prices_aggregated_3min.datetime <= datetime_threshold or datetime_threshold is null)
{% if var('realtime') %}
               and historical_prices_aggregated_3min.datetime >= min_datetime
