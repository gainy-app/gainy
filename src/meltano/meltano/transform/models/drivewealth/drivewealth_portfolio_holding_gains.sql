...
from {{ ref('profile_holdings_normalized') }}
         left join raw_data_1m using (profile_id, collection_id)
         left join raw_data_3m using (profile_id, collection_id)
         left join raw_data_1y using (profile_id, collection_id)
         left join raw_data_5y using (profile_id, collection_id)
         left join raw_data_total using (profile_id, collection_id)
