...
MAX_NOTIFICATIONS_PER_TEMPLATE = os.environ.get('MAX_NOTIFICATIONS_PER_TEMPLATE')
MAX_NOTIFICATIONS_PER_TEMPLATE = int(MAX_NOTIFICATIONS_PER_TEMPLATE) if MAX_NOTIFICATIONS_PER_TEMPLATE else None
